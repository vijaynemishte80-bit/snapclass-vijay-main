...
from src.components.dialog_create_subject import create_subject_dailog
from src.components.dialog_share_subject import share_subject_dailog
...
from src.components.attendance_voice_dialog import voice_attendance_dialog
    ...
    if subjects:
        for sub in subjects:
            stats = [
                ...
                ("🕰️","Class",sub["total_classes"])
            ]

            def share_btn(sub=sub):
                if st.button(f"Share Code:{sub['name']}",key=f"sub_{sub['subject_code']}",icon=":material/share:"):
...
def teacher_screen_login():
    ...
    teacher_username=st.text_input("Enter username",placeholder='vijaynemishte')
...
def teacher_screen_register():
    ...
    teacher_username=st.text_input("Enter username",placeholder='vijaynemishte')
    teacher_name=st.text_input("Enter name",placeholder='Vijay Nemishte')
